...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"example.avro.idl\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
  ...
  public static example.avro.idl.Message.Builder newBuilder() {
    return new example.avro.idl.Message.Builder();
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Builder */
  public static example.avro.idl.Message.Builder newBuilder(example.avro.idl.Message.Builder other) {
    return new example.avro.idl.Message.Builder(other);
  }
  
  /** Creates a new Message RecordBuilder by copying an existing Message instance */
  public static example.avro.idl.Message.Builder newBuilder(example.avro.idl.Message other) {
    return new example.avro.idl.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
    ...
    private Builder() {
      super(example.avro.idl.Message.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(example.avro.idl.Message.Builder other) {
      super(other);
    ...
    private Builder(example.avro.idl.Message other) {
            super(example.avro.idl.Message.SCHEMA$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'to' field */
    public example.avro.idl.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    public example.avro.idl.Message.Builder clearTo() {
      to = null;
    ...
    /** Sets the value of the 'from' field */
    public example.avro.idl.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    public example.avro.idl.Message.Builder clearFrom() {
      from = null;
    ...
    /** Sets the value of the 'body' field */
    public example.avro.idl.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    public example.avro.idl.Message.Builder clearBody() {
      body = null;
