...
public class Insanity implements org.apache.thrift.TBase<Insanity, Insanity._Fields>, java.io.Serializable, Cloneable, Comparable<Insanity> {
  ...
  public Map<Integer,Long> userMap; // required
  public List<Long> xtructs; // required
  ...
  public Insanity(Insanity other) {
    if (other.isSetUserMap()) {
      Map<Integer,Long> __this__userMap = new HashMap<Integer,Long>(other.userMap.size());
      for (Map.Entry<Integer, Long> other_element : other.userMap.entrySet()) {

        Integer other_element_key = other_element.getKey();
        Long other_element_value = other_element.getValue();

        Integer __this__userMap_copy_key = other_element_key;
    ...
    if (other.isSetXtructs()) {
      List<Long> __this__xtructs = new ArrayList<Long>(other.xtructs.size());
      for (Long other_element : other.xtructs) {
        __this__xtructs.add(other_element);
      }
  ...
  public void putToUserMap(int key, long val) {
    if (this.userMap == null) {
      this.userMap = new HashMap<Integer,Long>();
    }
  ...
  public Insanity setUserMap(Map<Integer,Long> userMap) {
    this.userMap = userMap;
    return this;
  }
  ...
  public java.util.Iterator<Long> getXtructsIterator() {
    return (this.xtructs == null) ? null : this.xtructs.iterator();
  }

  public void addToXtructs(long elem) {
    if (this.xtructs == null) {
      this.xtructs = new ArrayList<Long>();
    }
    this.xtructs.add(elem);
  }

  public List<Long> getXtructs() {
    return this.xtructs;
  }

  public Insanity setXtructs(List<Long> xtructs) {
    this.xtructs = xtructs;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case USER_MAP:
      if (value == null) {
        ...
        setUserMap((Map<Integer,Long>)value);
      }
      break;
  ...
  private static class InsanityStandardScheme extends StandardScheme<Insanity> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.userMap = new HashMap<Integer,Long>(2*_map0.size);
                int _key1;
                long _val2;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.xtructs = new ArrayList<Long>(_list4.size);
                long _elem5;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Insanity struct) throws org.apache.thrift.TException {
      ...
      if (struct.xtructs != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, struct.xtructs.size()));
          for (long _iter7 : struct.xtructs)
          {
      ...
      if (struct.userMap != null) {
        oprot.writeFieldBegin(USER_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, Long> _iter8 : struct.userMap.entrySet())
          {
      ...
      if (struct.isSetUserMap()) {
        {
          ...
          for (Map.Entry<Integer, Long> _iter9 : struct.userMap.entrySet())
          {
      ...
      if (struct.isSetXtructs()) {
        {
          ...
          for (long _iter10 : struct.xtructs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.userMap = new HashMap<Integer,Long>(2*_map11.size);
          int _key12;
          long _val13;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.xtructs = new ArrayList<Long>(_list15.size);
          long _elem16;
